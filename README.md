...
Tested on [MacBook Air M4](https://support.apple.com/en-us/122209#:~:text=Midnight-,Chip,-Apple%C2%A0M4%C2%A0chip) - up to **7x faster than realtime**:
...
|--------|---------|-------------|
| `-t, --target` | `8MB` | Target size (`8MB`, `8M`, `7.63MiB`, `8000KB`, `8000000`, `.008GB`) |
